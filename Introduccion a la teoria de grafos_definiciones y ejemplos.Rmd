...
plot(g,
     ...
     layout = LO)
```
Arriba creamos un *Grafo bipartita*el cual  tiene dos subconjuntos y los cuales no tienen aristas entre los nodos de un mismo subconjunto. Además existe el *grafo bipartita completo (Kn,n)*
```{r}
